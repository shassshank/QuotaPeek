# Installing and building QuotaPeek

This covers manual installation, building from source, and the full
architecture. For the quick version, see [README.md](README.md).
